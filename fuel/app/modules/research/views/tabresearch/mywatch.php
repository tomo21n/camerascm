...
<div class="col-md-12 container">
    ...
    <div class="row topline bottomline">
        <div class="col-md-4 col-xs-4 nopadding"><a data-toggle="popover" id="searchyahoo<?php echo $item["AuctionID"]; ?>" data-html="true" data-content="<div id='yahoolist<?php echo $item["AuctionID"]; ?>'></div>" data-placement="bottom" data-container="body"><?php echo Html::img($item["Image"]["Url"],array("class"=>"img-responsive")); ?></a></div>
