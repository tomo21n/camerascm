<h2>Listing MySoldlist</h2>
<br>
<?php echo Form::open(array('action'=>'yahoo/soldlist/','class'=>'form-horizontal','method'=>'get')); ?>
<fieldset>
    <!-- Open Id -->
    ...
    <div class="form-group">
        ...
        <div class="controls col-md-2">
            ...
            <?php echo Form::submit('sold', 'Sold更新', array('class' => 'btn btn-info')); ?>
        </div>
    </div>
</fieldset>
<?php echo Form::close(); ?>
...
<?php foreach ($soldlists as $item): ?>
    <tr>
			...
			<td>
				<?php echo Html::anchor('ebay/order/yahooorder/'.$item->auction_id, '<i class="glyphicon glyphicon-share"></i>'); ?>
