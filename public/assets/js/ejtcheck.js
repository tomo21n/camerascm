...
function getitem() {
    var item = document.querySelectorAll('.textWapper');
    return Array.prototype.map.call(item, function(e) {
        return  { product_name: e.querySelector('a').innerText ,
            price: e.querySelector('p.price').innerText,
            link: e.querySelector('a').getAttribute('href')                };
    });
}

casper.thenOpen('http://www.east-japan-trade.jp/pcs/',function() {
